<template>
    <div id="homework-container">
        ...
        <div class="row filter">
            <form @submit.prevent="findFriend" class="col">
            ...
            <form @submit.prevent="findUser" class="col">
        ...
        <div class="row">
            <div class="col">
                ...
                <ul id="friends-filter" class="friends-list">
                    ...
                    <li v-if="!friends.length">No one was found for your request.</li>
                </ul>
            </div>
            ...
            <div class="col">
                ...
                <ul id="friends-filter" class="friends-list">
                    <li v-if="user">
                        ...
                        <div v-if="!userIsFriend && user.id !== currentUserId">
...
export default {
    ...
    data() {
        return {
            // findFriendName: '',
            // findUserName: '',
            // friends: this.initialFriends,
            // user: this.initialUser
        };
    },
    methods: {
        findFriend() {
            // Имитация запроса на сервер для поиска друга
            axios.post('/find-friend', { name: this.findFriendName })
                .then(response => {
        ...
        findUser() {
            // Имитация запроса на сервер для поиска пользователя
            axios.post('/find-user', { name: this.findUserName })
                .then(response => {
