        ...
        <?php else: ?>
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $photo = $post->photo; ?>
                    ...
                    <div class="col-3">
                        <div class="post">
                            <a href="/post/<?php echo e($post->id); ?>"><img class="image" src="<?php echo e($photo->path); ?>" alt="send"></a>
                        </div>
                    </div>
...
<?php echo $__env->make('main_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/main.blade.php ENDPATH**/ ?>