    ...
    <sidebar>
        <div class="avatar">
            <div class="avatar__img">
                <?php if(\App\Models\UserInfo::where('user_id', \Illuminate\Support\Facades\Auth::id())->value('avatar') !== null): ?>
                    <img src="<?php echo e(\App\Models\UserInfo::where('user_id', \Illuminate\Support\Facades\Auth::id())->value('avatar')); ?>"
                         alt="avatar">
                <?php else: ?>
                    <img src="<?php echo e(asset('/storage/projectImages/no-avatar.png')); ?>"
                         alt="avatar">
                <?php endif; ?>
            </div>
            <div class="avatar__name"><?php echo e(\Illuminate\Support\Facades\Auth::user()->username); ?></div>
        </div>
        <nav class="menu">
            ...
            <a class="menu__item" href="/main/<?php echo e(\Illuminate\Support\Facades\Auth::id()); ?>">
...
<?php /**PATH /var/www/html/resources/views/sidebar.blade.php ENDPATH**/ ?>