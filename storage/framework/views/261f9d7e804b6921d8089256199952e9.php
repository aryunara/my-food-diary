        ...
        <div class="row">
            <div class="col">
                <ul id="friends-filter" class="friends-list">
                    <?php if(isset($friend)): ?>
                        <li><?php echo e($friend->friendUser->username); ?></li>
                    <?php elseif(!empty($friends)): ?>
                        <?php $__currentLoopData = $friends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $friend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="/main/<?php echo e($friend->friendUser->id); ?>"><?php echo e($friend->friendUser->username); ?></a>
                            </li>
...
<?php echo $__env->make('main_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/friendlist.blade.php ENDPATH**/ ?>